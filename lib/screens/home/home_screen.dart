...
import 'package:climit/screens/home/home_widgets.dart';
import 'package:climit/utils/widgets.dart';
import 'package:climit/variance_colors.dart';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Expanded(
                child: TabBarView(controller: _tabController, children: [
                  Send(
                      ...
                      onTransactionHashReceived: (hash) {
                        setState(() {
                          txHash = hash;
                        });
                      }),
              ...
              60.verticalSpace,
              if (txHash != null)
                Text('$txHash', style: TextStyle(color: VarianceColors.secondary)),
            ],
          ),
        ),
      ),
...
class Send extends StatelessWidget {
  const Send({
    ...
    required this.onTransactionHashReceived,
  }) : _formKey = formKey;

  final TextEditingController addressController;
  final GlobalKey<FormState> _formKey;
  final TextEditingController amountController;
  final void Function(String) onTransactionHashReceived;
